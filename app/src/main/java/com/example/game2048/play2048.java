...
public class play2048 extends Activity {
    ...
    {
        AlertDialog.Builder builder = new AlertDialog.Builder(this);
        builder.setMessage("Play again?").setPositiveButton("Yes", new DialogInterface.OnClickListener() {
            public void onClick(DialogInterface dialog, int id) {
                khoitao();
            }
        })
    ...
    public void trove1buoc()
    {
        ...
        if (check==true)
        {
            Toast.makeText(this,"You're already back!!", Toast.LENGTH_SHORT).show();
            return;
        }
